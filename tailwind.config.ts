    ...
    extend: {
      ...
      colors: {
        ...
        brick: {
          ...
          200: "hsl(var(--brick-200))",
          300: "hsl(var(--brick-300))",
          400: "hsl(var(--brick-400))",
          500: "hsl(var(--brick-500))",
          600: "hsl(var(--brick-600))",
          700: "hsl(var(--brick-700))",
          800: "hsl(var(--brick-800))",
          900: "hsl(var(--brick-900))",
        },
        amber: {
          50: "hsl(var(--amber-50))",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px rgba(181, 84, 43, 0.3)" },
          "50%": { boxShadow: "0 0 40px rgba(181, 84, 43, 0.5)" },
        },
      },
      animation: {
